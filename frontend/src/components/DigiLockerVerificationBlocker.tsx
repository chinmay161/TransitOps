...
export function DigiLockerModal({
  ...
  const startVerification = async () => {
    if (!driverId) {
      setErrorMsg("No valid driver profile ID provided for verification.");
      setStep("failure");
      return;
    }
            ...
            <div className="text-center py-4 space-y-5">
              ...
              <div className="flex gap-3 justify-center pt-2">
                ...
                <button
                  ...
                  className="bg-[#F5A623] hover:bg-[#D4891A] text-white py-2.5 px-4 rounded-lg text-xs font-bold transition-colors flex-1"
                >
                  Retry Verification
                </button>
              </div>
